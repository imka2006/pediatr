...
//           // Если видео, используем thumbnail_url (превью)
//           // Если превью нет — fallback на media_url (возможно фото)
//           const display_url = post.media_type === "VIDEO" && post.thumbnail_url
//             ? post.thumbnail_url
//             : post.media_url;
...
//                 {instagramPosts[0] && (
//                   <Post
//                     img={instagramPosts[0].thumbnail_url}
...
//                 {instagramPosts[1] && (
//                   <Post
//                     img={instagramPosts[1].thumbnail_url}
...
//                   <Post
//                     img={instagramPosts[2].thumbnail_url}
